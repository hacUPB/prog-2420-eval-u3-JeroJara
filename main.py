def main():
    ...
    eventos = [
        "1. Copa Infantil de Futbol", 
        "2. Liga de Padel Amateur", 
        "3. Ajedrez en el barrio", 
        "4. Torneo de baloncesto callejero"
    ]
    apuestas = []
    ...
    def realizar_apuesta(usuario, evento_elegido, monto_apostar, cuota):
        ...
        # Se crea un diccionario en el que se almacena la información de las apuestas realizadas.
        apuestas.append({
            'usuario': usuario, 
        ...
        while controlador:
            if 1 <= cuota <= 5:
                ...
                print("Por favor, ingrese una cuota válida entre 1 y 5")
